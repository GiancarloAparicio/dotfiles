...
alias logs="docker compose logs 2>&1 | ccze -m ansi | less -R"
...
alias share="filebrowser -a 127.0.0.1 --noauth -p 8888  -r '$(pwd)' -c ~/.config/filebrowser"
alias catn="$(which cat)"
alias watch-filef="tail -n 50 -f"
alias wf="watch-filef"
alias cat="bat"
alias cp="cp -r -u -v"
alias neol='macchina -S -K -U -C'
alias neo='macchina -S -K -U -C'
alias a='asdf'
alias c='clear'
alias e='exit'
